...
The default RC input is configured on the UART2(SERIAL2) RX2 input and can be used for all ArduPilot supported unidirectional receiver protocols.
* SBUS/DSM/SRXL/PPM connects to the RX2 pin.
...
External OSD support such as DJI or DisplayPort is preconfigured on SERIAL 4 but supported on any spare UART. See :ref:`common-msp-osd-overview-4.2` for more info.
